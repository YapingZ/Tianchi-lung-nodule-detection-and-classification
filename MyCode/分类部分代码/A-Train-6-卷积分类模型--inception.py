...
fenlei_fit('Fenge_32_32_32_inception', load_check = False, batch_size=40, epochs=100, check_name = 'Fenge_32_32_32_0703')
...
model_pred = load_model(os.path.join(model_paths,'Fenge_32_32_32_inception.h5'))
